...
if (typeof window.notificationsInitialized === "undefined") {
  ...
  function markAsRead(notificationId, orderId = null) {
  ...
  window.renderNotifications = function () {
    ...
    container.innerHTML = sortedNotifs
      .map((notif) => {
        ...
        const match = notif.message.match(/ORD-[A-Z0-9-]+/);
        const orderId = match ? match[0] : null;

        return `
            <div class="notif-item ${notif.status === 0 ? "unread" : ""}" 
                 data-id="${notif.id}"
                 onclick="markAsRead(${notif.id}, '${orderId}')">
              ...
              <div class="notif-content">
                ...
                <div class="notif-time">
                  ...
                  ${timeAgo(parseUTCDate(notif.created_at))}
                </div>
              </div>
              <div class="notif-actions">
                <button class="notif-delete" onclick="markAsRead(${notif.id})" title="Delete">
